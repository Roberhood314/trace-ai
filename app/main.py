...
def privacy_policy_page():
    return HTMLResponse("""<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>TRACE AI Privacy Policy</title><style>body{font-family:system-ui,-apple-system,sans-serif;max-width:860px;margin:40px auto;padding:0 20px;line-height:1.65;color:#172033}h1,h2{color:#0b1220}small{color:#64748b}</style></head><body><h1>TRACE AI Privacy Policy</h1><small>Last updated: 26 September 2026</small><p>TRACE AI processes only the information required to provide authentication, security, operational, case-management and community-support features.</p><h2>Data we process</h2><p>Depending on enabled features, this may include Pi account identifiers, app role information, user-submitted reports, authorized camera or location data, device telemetry, and operational audit records. Camera and location access require user permission.</p><h2>Official data</h2><p>Wanted-person information displayed by TRACE AI is sourced from official public sources when identified as such. TRACE AI does not create replacement identity images when an official portrait is unavailable.</p><h2>Use and security</h2><p>Data is used to operate the app, secure access, maintain audit trails, provide authorized analysis and improve system reliability. Access is role-based and sensitive operations are logged.</p><h2>Sharing</h2><p>TRACE AI does not sell personal data. Information may be shared only where required to operate authorized services, comply with law, or support legitimate security and safety workflows.</p><h2>Retention and deletion</h2><p>Data is retained only as needed for operational, security, legal or audit purposes. Users may request account deletion through the account-deletion process provided by TRACE AI.</p><h2>Contact</h2><p>For privacy or account-deletion questions, use the support contact provided in the TRACE AI app.</p></body></html>""")

@app.get("/terms-of-service", include_in_schema=False)
def terms_of_service_page():
    return HTMLResponse("""<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>TRACE AI Terms of Service</title><style>body{font-family:system-ui,-apple-system,sans-serif;max-width:860px;margin:40px auto;padding:0 20px;line-height:1.65;color:#172033}h1,h2{color:#0b1220}small{color:#64748b}</style></head><body><h1>TRACE AI Terms of Service</h1><small>Last updated: 26 September 2026</small><p>By using TRACE AI, you agree to use the service lawfully, responsibly and only for permitted purposes.</p><h2>Permitted use</h2><p>TRACE AI provides information, analysis, reporting, mapping and authorized operational tools. Users must not use the service for harassment, unlawful surveillance, impersonation, unauthorized device control, or any illegal activity.</p><h2>Data and analysis</h2><p>Automated analysis is assistive. Identity, safety and enforcement-related conclusions require human verification and, where applicable, confirmation from official sources or competent authorities.</p><h2>Availability</h2><p>External data sources, networks, Pi services, GPS, camera, telemetry and third-party connectors may be unavailable or delayed. TRACE AI does not guarantee uninterrupted operation.</p><h2>Security</h2><p>Users are responsible for safeguarding their accounts, devices and credentials. Attempts to bypass security controls or access restricted functions are prohibited.</p><h2>Changes</h2><p>These terms may be updated as TRACE AI evolves. Continued use after an update constitutes acceptance of the revised terms.</p></body></html>""")
